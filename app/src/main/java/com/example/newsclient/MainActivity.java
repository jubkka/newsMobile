...
public class MainActivity extends AppCompatActivity {
    private static final String[] TOPICS = {"Politics", "Economics", "Sport", "Cultura", "Technologies", "Science", "Health", "Travel", "Education", "Entertainment"};
    ...
    private class GetNewsTask extends AsyncTask<String, Void, String> {
        ...
        protected String doInBackground(String... params) {
            ...
            System.out.println("Вывод" + params[0]);
            // Здесь вызывается функция searchNews с выбранной темой
            // Возвращаем результат запроса
            try {
                return NewsApiClient.searchNews(topic, "en", 10);
            } catch (IOException e) {
